...
public class QueenSideCastleMove extends CastleMove {
    ...
    /**
     * To construct a queen side Castling Move, send in the current board, the piece (king) on the board being moved,
     ...
     * @param queenSideRook the rook on the queens side
    ...
    public QueenSideCastleMove(final Board board, final Piece movedPiece, final int destinationCoordinate,
                              final Rook queenSideRook, final int castleRookOrigin, final int castleRookDestination) {
        super(board, movedPiece, destinationCoordinate, queenSideRook, castleRookOrigin, castleRookDestination);
    }
